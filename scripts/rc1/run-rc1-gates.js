...
const GATES = [
  ...
  { id: "ASSIGN-732", domain: "functional", cmd: ["node", "--test", "backend/lib/teacherAssignmentsRepository.test.js"] },
  { id: "LEGACY-PEDAGOGY", domain: "functional", cmd: ["node", "--test", "backend/lib/legacyPedagogyStaffStateWrite.test.js", "backend/lib/teacherAssignmentsManagement.test.js", "backend/lib/legacyStudentsStateWrite.test.js", "backend/lib/legacyClassesStateWrite.test.js"] },
  ...
  { id: "E2E-0006-MEMORY", domain: "e2e", cmd: ["npm", "run", "verify:e2e-0006"] },
  { id: "SETUP-GUIDED", domain: "e2e", cmd: ["npm", "run", "verify:school-setup-guided-green"] },
