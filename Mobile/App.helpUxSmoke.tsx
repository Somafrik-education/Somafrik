/**
 * Entrée recette Aide mobile — jamais le main Expo de production.
 * Chargée seulement si Metro démarre avec SOMAFRIK_HELP_UX_SMOKE_ENTRY=1.
 */
import { type ComponentProps } from "react";
import { SafeAreaProvider } from "react-native-safe-area-context";
import { MaterialCommunityIcons } from "@expo/vector-icons";
import { MD3LightTheme, PaperProvider, type MD3Theme } from "react-native-paper";
import HelpUxSmokeApp from "./recette/HelpUxSmokeApp";
...
export default function HelpUxSmokeRoot() {
  return (
    <SafeAreaProvider>
