#!/usr/bin/env node
/**
 * Preuve lots restants : PD-01…PD-04, PD-06, PD-07 encore ROUGES.
 * PD-05 (Finance élève) est GREEN — voir progressiveDisclosureUx.test.ts.
...
const EXPECTED = ["PD-01", "PD-02", "PD-03", "PD-04", "PD-06", "PD-07"];
