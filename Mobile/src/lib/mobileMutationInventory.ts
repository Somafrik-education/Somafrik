...
export const MOBILE_MUTATION_INVENTORY = [
  ...
  { name: "validateStudentEnrollment", method: "POST", path: "/students/:studentId/enrollments/:enrollmentId/validate", class: "D", outbox: false, domain: "students" },
  { name: "assignStudentEnrollmentClass", method: "POST", path: "/students/:studentId/enrollments/:enrollmentId/assign-class", class: "D", outbox: false, domain: "students" },
  { name: "transferStudentEnrollment", method: "POST", path: "/students/:studentId/enrollments/:enrollmentId/transfer", class: "D", outbox: false, domain: "students" },
  { name: "closeStudentEnrollment", method: "POST", path: "/students/:studentId/enrollments/:enrollmentId/close", class: "D", outbox: false, domain: "students" },
