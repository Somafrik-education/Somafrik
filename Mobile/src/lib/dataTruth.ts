...
export const DATA_TRUTH_COPY = {
  ...
  emptyUnpaid: "Aucun impayé.",
  errorUnpaid: "Impossible de charger les impayés.",
  offlineUnpaid: "Réseau indisponible. Les impayés n'ont pas pu être chargés.",
...
export const DATA_TRUTH_TEST_IDS = {
  ...
  unpaidEmpty: "unpaid-empty",
  unpaidError: "unpaid-error",
