...
export default function ClassesScreen({ navigation }: any) {
  ...
  const { classesData, studentsData, teachersData, assignmentsData, schoolsData, presencesSnapshot, loadClasses, loadStudents, loadPresences, loadTeachers, classesSnapshot, studentsSnapshot, resourceScopeKey } = useAdminData();
