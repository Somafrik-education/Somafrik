...
const I = {
  ...
  feeGrids: { label: "Grilles de frais", icon: "pricetags-outline" as const, route: "FeeGrids", view: "FeeGrids" },
  ...
  classStats: { label: "Stats de classe", icon: "stats-chart-outline" as const, route: "ClassGradesStats", view: "ClassGradesStats" },
  exams: { label: "Examens", icon: "clipboard-outline" as const, route: "Exams", view: "Exams" },
...
const schoolAdminItems: RoleDrawerItem[] = [
  ...
  quotidien(I.feeGrids),
  quotidien(I.grades),
  quotidien(I.classStats),
  quotidien(I.exams),
