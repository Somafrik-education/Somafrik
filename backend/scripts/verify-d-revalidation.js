...
/**
 * Gate lot D — revalidation Planning + Présences + Sync L1
 * après #435 / #436 / #437. Evidence/test-only.
...
function sourceGuards() {
  ...
  assert.match(findings, /Lot D revalidation/);
...
function main() {
  ...
  console.log("OK verify-d-revalidation — Planning / Présences / Sync L1 + findings #437");
}
