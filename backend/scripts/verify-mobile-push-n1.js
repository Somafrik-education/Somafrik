...
function sourceGuards() {
  ...
  assert.match(mobile, /export function resolveExpoConstantsInterop/);
  assert.match(mobile, /record\.default/);
  assert.match(mobile, /return resolveExpoConstantsInterop\(mod\)/);
