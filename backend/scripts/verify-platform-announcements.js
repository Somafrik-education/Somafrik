...
function main() {
  ...
  run("npm", ["--prefix", "web", "run", "test", "--", "src/lib/announcementsPlatform.test.ts", "src/lib/announcementsC3.test.ts", "src/lib/announcementsRead.lotc.test.tsx"], "web announcements platform+C3");
