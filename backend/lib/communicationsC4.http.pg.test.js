...
async function main() {
  ...
  try {
    ...
    const parentA = mint(tokens, { sub: PARENT_A, schoolCode: "SCH-C4-A", role: "Parent", roleKeys: ["PARENT"], permissions: ["Notifications:READ","Messages:READ","Messages:CREATE","Announcements:READ"] });
