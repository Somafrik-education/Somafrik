...
/**
 * RED — PR C reset mot de passe + email transactionnel.
 * Aucun correctif métier. Les tests RED échouent sur un trou réel.
 * Les tests GREEN-* figent les contrats déjà vrais (ne pas casser au GREEN).
 */
