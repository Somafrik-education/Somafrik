...
function inventoryParentRelations(state = {}) {
  ...
  for (const relation of relations) {
    ...
    else if (userById && normalizeId(userById.contactId)) status = "legacy_user_id";
    ...
    items.push({
      ...
      status,
      mappedContactId: normalizeId(userById?.contactId) || (byContact ? fromContactId : ""),
    });
  }
 ...
 * Ne touche pas les lignes déjà canoniques ni les orphelines.
 */
