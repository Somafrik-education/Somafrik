...
const routePermissions = {
  ...
  "POST /api/exams": ["Organiser examens", "Valider examens", "Examens:UPDATE", "ALL_PRIVILEGES"],
  "PATCH /api/exams/:examId": ["Organiser examens", "Valider examens", "Examens:UPDATE", "ALL_PRIVILEGES"],
  "POST /api/exams/:examId/validate": ["Valider examens", "ALL_PRIVILEGES"],
  "POST /api/exams/:examId/cancel": ["Organiser examens", "Valider examens", "ALL_PRIVILEGES"],
  "POST /api/exams/:examId/archive": ["Organiser examens", "Valider examens", "ALL_PRIVILEGES"],
