...
const REPOSITORY_METHODS = Object.freeze([
  ...
  "listSchoolPaymentMethods",
  "replaceSchoolPaymentMethods",
  "listCatalogFeeTypes",
  "getFinanceCatalog",
  ...
  "patchConfiguredRolePermissions",
