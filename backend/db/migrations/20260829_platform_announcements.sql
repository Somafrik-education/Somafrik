-- ANN-PLATFORM-1 — Annonces Superadmin (domaine plateforme, hors C3 établissement)
-- Idempotent. Boot via ensureClientsCanonicalBootstrap → applyPlatformAnnouncementsSchema.
