-- LOT 4 — snapshots publiés immuables, identité QR stratégie A, outbox atomique.
-- Bytes canoniques en BYTEA (JCS). Clés Ed25519 / wrapping hors PostgreSQL.
-- Idempotence : UNIQUE (school_id, report_card_id, published_snapshot_version).
