 ...
 * Suite Vitest (CI Risk-targeted) : describe/it, pas un script tsx nu.
 */
...
describe("UX Communication Web", () => {
  it("cartes compactes : repliées par défaut, détails et actions après ouverture", () => {
