...
export const SCHOOL_ENTITY_MODULES = ([
  ...
  },
  {
    ...
    group: "utilisateurs",
    description:
      "Lecture des effectifs PostgreSQL. Inscription et rattachement de classe via Mon établissement → Classes.",
    // Formulaire EntityPage retiré — CRUD métier via StudentsListPage / Classes.
    fields: [],
