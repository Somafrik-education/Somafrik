...
import loginBackground from "../assets/somafrik-login-background.webp";
    ...
    >
      <img
        ...
        onError={() => {
          ...
          console.error("[login] somafrik-login-background.webp failed to decode or load", loginBackground);
        }}
        className="pointer-events-none absolute inset-0 h-full w-full object-cover object-center"
      />
      {backgroundStatus !== "error" ? (
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 bg-slate-950/25" />
      ) : null}
