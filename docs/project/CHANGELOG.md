...
- **RC1 G1 — requalification après #733 (#719 / #742)** : rapports `docs/release/RC1-*.md` ; harness `verify:rc1-gates` / `verify:rc1-e2e` / `verify:rc1-performance` ; preuves isolées + PG local sur `develop@109fa474`. P0/P1 reproduits = 0. Production unmodified. HOLD READY+MERGE.
