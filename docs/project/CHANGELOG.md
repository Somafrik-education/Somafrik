...
- **RC1 G1 — requalification après #733 (#719 / #722)** : rapports `docs/release/RC1-*.md` ; harness `verify:rc1-gates` / `verify:rc1-performance` ; preuves rejouées sur `develop@109fa474`. Production unmodified. HOLD READY+MERGE.
