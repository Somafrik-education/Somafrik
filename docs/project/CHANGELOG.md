...
- **GO Production G0 — pont ChatGPT CTO / Cursor / GitHub (#720)** : contrat opérationnel `docs/project/GO-PRODUCTION.md` (rôles, templates de communication, phases G0–G7, règles absolues) ; ADR-015 ; snapshot baseline `docs/audits/go-production-g0-baseline-2026-09-19.md` (`develop@afa01321`, freeze fonctionnel, HOLD). Production unmodified. HOLD READY+MERGE.
