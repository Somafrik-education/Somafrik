...
- **RC1 G1 — requalification après #733 (#719 / #722)** : rebase `develop@109fa474` ; rapports `docs/release/RC1-*.md` ; harness `verify:rc1-gates` / `verify:rc1-e2e` / `verify:rc1-performance` ; #732 PASS (mémoire+PG) ; #645/#717 CLOSED ; #646/#737 hors gate ; P0/P1 reproduits = 0. E2E HTTP seedé + perf PG encore opérateur. Production unmodified. HOLD READY+MERGE.
