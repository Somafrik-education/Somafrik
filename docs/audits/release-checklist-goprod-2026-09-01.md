...
**Aucun acte ci-dessous n’est exécuté par l’agent.** Chaque phase exige **USER GO** explicite. Candidat figé à la revalidation : `develop@78228be06286b464afd9e691fb227d16be95a63a`. Si `develop` avance : STOP, rebase, revalider.
